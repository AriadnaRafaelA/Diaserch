...
const Footer = () => {
  ...
  return (
    <div style={tablaStyles}>
      <footer>
        <p>
          Los precios y promociones mostrados en esta página online son
          exclusivos y estos pueden diferir de los precios y promociones de
          sucursal.
        </p>
        <p style={p}> © Diaserch 2023 [Instituto Politecnico Nacional]. </p>
        <p style={p}>
          ESCOM IPN, Unidad Profesional Adolfo López Mateos, Av. Juan de Dios
          Bátiz, Nueva Industrial Vallejo, Gustavo A. Madero, 07320 Ciudad de
          México, CDMX
        </p>
