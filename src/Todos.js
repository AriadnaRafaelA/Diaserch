      ...
      <div>
        ...
        {medicinas.map((medicina, index) => (
          <div key={index} style={borderStyle2}>
            ...
            <div style={{ width: '10%', textAlign: 'left' }}>
              <p>
                Aquí van las imágenes de arriba, abajo e igual
              </p>
            </div>
            <div style={{ width: '10%', textAlign: 'left' }}>
              <p>
                <a href={`https://www.benavides.com.mx/${medicina.laboratorio.replace(/\s+/g, '-')}-${primeraPalabra}-${medicina.presentacion.replace(/\s+/g, '-')}`} target="_blank" rel="noopener noreferrer">
                  <img
                    src="./web.png"
                        ...
                        <div style={tablaStyles3}>
                          ...
                          <img src="http://maps.google.com/mapfiles/ms/icons/blue-dot.png" alt="Marka" />
                            ...
                            >
                              ...
                              {medicinas.some(medicina => medicina.farmacia === 'Farmacia Guadalajara') && nearestPharmacyCoordinates && (
                                <Marker
                              ...
                              {medicinas.some(medicina => medicina.farmacia === 'Farmacia San Pablo') && nearestPharmacyCoordinates2 && (
                              <Marker
                              ...
                              {medicinas.some(medicina => medicina.farmacia === 'Farmacia Benavides') && nearestPharmacyCoordinates3 && (
                                <Marker
                          ...
                          <div style={{ display: 'flex', flexDirection: 'row', justifyContent: 'space-between' }}>
                            <div style={{ width: '33.33%', textAlign: 'center'  }}>
                              <p>{medicinas.some(medicina => medicina.farmacia === 'Farmacia Guadalajara') && nearestPharmacyCoordinates && (
                                    <button onClick={handleVerRutas} style={buttonStyles}>Farmacia Guadalajara</button> 
                                    )}</p>
                            </div>
                            <div style={{ width: '33.33%', textAlign: 'center'  }}>
                              <p>{medicinas.some(medicina => medicina.farmacia === 'Farmacia San Pablo') && nearestPharmacyCoordinates2 && (
                                    <button onClick={handleVerRutas2} style={buttonStyles}>Farmacia San Pablo</button> 
                                    )}</p>
                            </div>
                            <div style={{ width: '33.33%', textAlign: 'center' }}>
                              <p>{medicinas.some(medicina => medicina.farmacia === 'Farmacia Benavides') && nearestPharmacyCoordinates3 && (
