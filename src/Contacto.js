    ...
    () => [
      {
        ...
        direccion:
          "C. Apango 17, Gral Felipe Berriozabal, Gustavo A. Madero, 07100 Ciudad de México, CDMX",
      ...
      },
      {
        ...
        direccion:
          "Tecnológico #1, Col del Bosque, Gustavo A. Madero, 07207 Ciudad de México, CDMX",
      ...
      },
      {
        ...
        direccion:
          "Blvd. del Temoluco 276, Acueducto de Guadalupe, Gustavo A. Madero, 07790 Ciudad de México, CDMX",
      ...
      },
      {
        ...
        direccion:
          "Miguel Bernard 577, Siete Maravillas, Gustavo A. Madero, 07707 Ciudad de México, CDMX",
      ...
      },
      {
        ...
        direccion:
          "Calz. Ticomán 1109, La Laguna Ticoman, Gustavo A. Madero, 07340 Ciudad de México, CDMX",
      ...
      },
      {
        ...
        direccion:
          "Cabo Buena Esperanza 3, Gabriel Hernández, Gustavo A. Madero, 07089 Ciudad de México, CDMX",
      ...
      },
      {
        ...
        direccion:
          "Calz. San Juan de Aragón 200, Constitución de la República, Gustavo A. Madero, 07469 Ciudad de México, CDMX",
      ...
      },
      {
        ...
        direccion:
          "Calz. de los Misterios 808, Tepeyac Insurgentes, Gustavo A. Madero, 07020 Ciudad de México, CDMX",
    ...
    () => [
      {
        ...
        direccion:
          "Av Cuautepec 4A, Jorge Negrete, Gustavo A. Madero, 07280 Ciudad de México, CDMX",
      },
      {
        title: "Casma",
        position: { lat: 19.49166260896163, lng: -99.1362576346612 },
        direccion:
          "Av. Montevideo 415, Lindavista Sur, Gustavo A. Madero, 07300 Ciudad de México, CDMX",
      },
      {
        title: "Montevideo",
        position: { lat: 19.48829829204483, lng: -99.12611729968107 },
        direccion:
          "Av. Montevideo 145, Lindavista, Gustavo A. Madero, 07300 Ciudad de México, CDMX",
      },
      {
        title: "La Villa",
        position: { lat: 19.474622714702445, lng: -99.12157732982925 },
        direccion:
          "Calz de Guadalupe 512, Industrial, Gustavo A. Madero, 07800 Ciudad de México, CDMX",
      },
      {
        title: "Albino Corzo",
        position: { lat: 19.463575145774783, lng: -99.1108678110531 },
        direccion:
          "Ángel Albino Corzo 3128, Tablas de San Agustín, Gustavo A. Madero, 07860 Ciudad de México, CDMX",
      },
      {
        title: "Eduardo Molina",
        position: { lat: 19.497258555853612, lng: -99.09065645913292 },
        direccion:
          "Eduardo Molina 1922, Vasco de Quiroga, Gustavo A. Madero, 07440 Ciudad de México, CDMX",
      },
      {
        title: "San Felipe",
        position: { lat: 19.492312510159614, lng: -99.07462917542122 },
        direccion:
          "Coyuca 61, San Felipe de Jesús, Gustavo A. Madero, 07510 Ciudad de México, CDMX",
      },
    ],
    [],
  );
    ...
    () => [
      {
        ...
        direccion:
          "Eje Vial 1 Pte. (Calzada Vallejo 1111, Patera Vallejo I Secc, Gustavo A. Madero, 07710 Ciudad de México, CDMX",
        ...
        >
          ...
          <div style={{ flex: 1 /*, borderBottom: '1px solid black' */ }}>
            <div style={containerStyles}>
              ...
              <div style={{ display: "flex" }}>
                <div style={tablaStyles}>
                  ...
                  >
                    <a
                      href="https://www.farmaciasguadalajara.com/"
                      target="_blank"
            ...
            {nearestPharmacyCoordinates && (
              <div style={containerStyles}>
                {mostrarBotoncerca && (
                  <button onClick={handleMostrarMapaCerca} style={buttonStyles}>
                    Farmacia cercana
                  </button>
                )}
              </div>
                ...
                <div style={title}>
                  ...
                  {farmacias.map((farmacia, index) => (
                    <div key={index}>
                      <hr />
                      <p>
                        <strong>Dirección:</strong> {farmacia.direccion}
                      </p>
                      <p>
                        <strong>Teléfono:</strong> {farmacia.telefono}
                      </p>
                    </div>
                  ))}
                </div>
          ...
          <div style={{ flex: 1 }}>
            {mostrarMapa && (
              <div style={mapStyles}>
                ...
                <button onClick={handleUpdateLocation} style={buttonStyles}>
            ...
            {mostrarMapaCerca && (
              <div style={mapStyles}>
                ...
                <button onClick={handleVerRutas} style={buttonStyles}>
      ...
      <div style={farmaciaStyles}>
        ...
        >
          ...
          <div
            style={{
              flex: 1,
              /*, borderBottom: '1px solid black' */ padding: "1px",
            }}
          >
            <div style={containerStyles}>
              ...
              <div style={{ display: "flex" }}>
                <div style={tablaStyles}>
                  ...
                  >
                    <a
                      href="https://www.farmaciasanpablo.com.mx/"
                      target="_blank"
                      rel="noopener noreferrer"
                    >
                      <img
              ...
              {mostrarBoton2 && (
                <button onClick={handleMostrarMapa2}>
                  Todas las farmacias
                </button>
              )}
            </div>
            ...
            {nearestPharmacyCoordinates2 && (
              <div style={containerStyles}>
                {mostrarBotoncerca2 && (
                  <button
                    onClick={handleMostrarMapaCerca2}
                    style={buttonStyles}
                  >
                    Farmacia cercana
                  </button>
          ...
          <div style={{ flex: 1 }}>
            {mostrardirectorioSP && (
              <div>
                ...
                <div style={title}>
                  <p>
                    Farmacias San Pablo cuenta con el mismo número para todas
                    sus sucursales
                  </p>
                  <p>
                    <strong>Teléfono:</strong> 800 0726 722{" "}
                  </p>
          ...
          <div style={{ flex: 1 }}>
                  ...
                  <div>
                    ...
                    >
                      <Marker
                        title="Cuautepec"
                        position={{
                          lat: 19.52296681356565,
                          lng: -99.14148576089354,
                        }}
                      />
                      <Marker
                        title="Casma"
                        position={{
                          lat: 19.49166260896163,
                          lng: -99.1362576346612,
                        }}
                      />
                      <Marker
                        title="Montevideo"
                        position={{
                          lat: 19.48829829204483,
                          lng: -99.12611729968107,
                        }}
                      />
                      <Marker
                        title=" La Villa"
                        position={{
                          lat: 19.474622714702445,
                          lng: -99.12157732982925,
                        }}
                      />
                      <Marker
                        title="Albino Corzo"
                        position={{
                          lat: 19.463575145774783,
                          lng: -99.1108678110531,
                        }}
                      />
                      <Marker
                        title="Eduardo Molina"
                        position={{
                          lat: 19.497258555853612,
                          lng: -99.09065645913292,
                        }}
                      />
                      <Marker
                        title="San Felipe"
                        position={{
                          lat: 19.492312510159614,
                          lng: -99.07462917542122,
                        }}
                      />
            ...
            {mostrarMapaCerca2 && (
              <div style={mapStyles}>
                ...
                <button onClick={handleVerRutas2} style={buttonStyles}>
                  Ver Rutas en Google Maps
                </button>
                {mostrarMapaCerca2 && (
                  <div>
      ...
      <div style={farmaciaStyles}>
        ...
        >
          ...
          <div
            style={{
              flex: 1,
              /*, borderBottom: '1px solid black' */ padding: "10px",
            }}
          >
            <div style={containerStyles}>
              ...
              <div style={{ display: "flex" }}>
                <div style={tablaStyles}>
                  ...
                  >
                    <a
                      href="https://www.benavides.com.mx/"
                      target="_blank"
                      rel="noopener noreferrer"
                    >
                      <img
              ...
              {mostrarBoton3 && (
                <button onClick={handleMostrarMapa3}>
                  Todas las farmacias
                </button>
              )}
            </div>
            ...
            {nearestPharmacyCoordinates3 && (
              <div style={containerStyles}>
                {mostrarBotoncerca3 && (
                  <button
                    onClick={handleMostrarMapaCerca3}
                    style={buttonStyles}
                  >
                    Farmacia cercana
                  </button>
          ...
          <div style={{ flex: 1 }}>
            {mostrarMapa3 && (
              <div style={mapStyles}>
                ...
                <button onClick={handleVerRutas3} style={buttonStyles}>
                  Ver Rutas en Google Maps
                </button>
                {mostrarMapa3 && (
                  <div>
