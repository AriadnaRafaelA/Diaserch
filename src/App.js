...
function App(props) {
  ...
  const handleInputChange = (e) => {
    ...
    if (inputValue === "") {
      ...
      const suggestedMedicines = filteredMedicines.map(
        (medicina) => medicina.laboratorio,
      );
  ...
  const buscarPorNombre = () => {
    ...
    const medicinasEncontradas = medicinas.filter((medicina) => {
      ...
      const nombreEncontrado = medicina.laboratorio
        .toLowerCase()
        .includes(nombreBuscado.toLowerCase());
      const formulaEncontrada = medicina.formula
        .toLowerCase()
        .includes(nombreBuscado.toLowerCase());
  ...
  const ordenarMedicinas = (medicinas, orden) => {
    switch (orden) {
      ...
      case "reverso":
        return medicinas.sort((a, b) =>
          b.laboratorio.localeCompare(a.laboratorio),
        );
      case "mayorPrecio":
        return medicinas.sort(
          (a, b) => quitarSimboloDolar(b.precio) - quitarSimboloDolar(a.precio),
        );
      case "menorPrecio":
        return medicinas.sort(
          (a, b) => quitarSimboloDolar(a.precio) - quitarSimboloDolar(b.precio),
        );
      case "disponibilidad":
        return medicinas.sort((a, b) =>
      ...
      case "noDisponibilidad":
        ...
        return medicinas.sort((a, b) => {
          if (
            a.disponibilidad === "Agotado" &&
            b.disponibilidad !== "Agotado"
          ) {
        ...
        <p>
          ...
          >
            ...
            <div style={{ width: "15%", textAlign: "left" }}>
              ...
              {farmaciaNombre === "Farmacia Guadalajara" && (
                <p>Página no apta para mostrar disponibilidad</p>
              )}
            </div>
              ...
              {copied && (
                ...
                >
                  <div className="modal-content">
                    <span onClick={() => setCopied(false)}>&times;</span>
                    <p>Copiado</p>
                  </div>
                </div>
              )}
                    ...
                    <div style={buscadorEstilo}>
                            ...
                            {[
                              ...new Set(
                                sugerencias.map((sugerencia) =>
                                  sugerencia.toLowerCase().trim(),
                                ),
                              ),
                            ].map((sugerencia, index) => (
                              <li
                                key={index}
                                onClick={() => autocompletar(sugerencia)}
                                ...
                                style={{
                                  ...
                                  backgroundColor:
                                    indiceHover === index
                                      ? "#277FB3"
                                      : "inherit", // Cambiar el color al pasar el cursor
                                  color:
                                    indiceHover === index ? "#fff" : "inherit", // Cambiar el color del texto al pasar el cursor
                                }}
                              >
                                {sugerencia}
                              </li>
                      ...
                      {mostrarContenido ? null : (
                        <div style={{ padding: "8px" }}>
                          <p>
                            <button onClick={mostrarOcultarContenido}>
                    ...
                    <div style={{ textAlign: "center" }}>
                      <div style={tablaStyles3}>
                        {mostrarContenido && (
                          ...
                          <div style={tablaStyles}>
                            ...
                            >
                              <div style={texto2}>
                                <div
                                  onClick={() => toggleFarmacia("guadalajara")}
                                  style={{
                                    ...borderStyle,
                                    cursor: "pointer",
                                    marginTop: "20px",
                                ...
                                >
                                  <h3>
                                    ...
                                    {activeFarmacia === "guadalajara"
                                      ? "▲"
                                      : "▼"}
                                  </h3>
                                </div>
                                {activeFarmacia === "guadalajara" &&
                                  renderFarmaciaContent("guadalajara")}

                                <div
                                  onClick={() => toggleFarmacia("sanPablo")}
                                  style={{
                                    ...borderStyle,
                                    cursor: "pointer",
                                    marginTop: "20px",
                                ...
                                >
                                  <h3>
                                    ...
                                    />{" "}
                                    Farmacia San Pablo{" "}
                                    {activeFarmacia === "sanPablo" ? "▲" : "▼"}
                                  </h3>
                                </div>
                                {activeFarmacia === "sanPablo" &&
                                  renderFarmaciaContent("sanPablo")}

                                <div
                                  onClick={() => toggleFarmacia("benavides")}
                                  style={{
                                    ...borderStyle,
                                    cursor: "pointer",
                                    marginTop: "20px",
                                ...
                                >
                                  <h3>
                                    ...
                                    />{" "}
                                    Farmacia Benavides{" "}
                                    {activeFarmacia === "benavides" ? "▲" : "▼"}
                                  </h3>
                                </div>
                                {activeFarmacia === "benavides" &&
                                  renderFarmaciaContent("benavides")}
                              </div>
                            </div>
                          </div>
                        )}
                          ...
                          <div>
                            ...
                            <div style={tablaStyles}>
                              ...
                              <div>
                                ...
                                <FarmaciaComponent
                                  farmaciaNombre="Farmacia Guadalajara"
                                  medicinas={medicinasEncontradas.filter(
                                    (medicina) =>
                                      medicina.farmacia ===
                                      "Farmacia Guadalajara",
                                  )}
                        ...
                        <div style={tablaStyles2}>
                          ...
                          <p style={texto}>
                            * El color de la marca corresponde a la farmacia
                            asignada
                          </p>
